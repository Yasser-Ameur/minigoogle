...
const SearchBox = forwardRef(function SearchBox(
  { onSubmit, onLucky, initialQuery = '', autoFocus = false, size = 'lg' },
  ref
) {
      ...
      >
        ...
        {onLucky && (
          <div className="home-buttons">
            <button type="submit">MiniGoogle Search</button>
            <button type="button" onClick={() => onLucky(value.trim())}>I'm Feeling Lucky</button>
          </div>
        )}
      </form>
    </div>
